...
export async function GET() {
  const reponse = await apiBackendFluxAuthentifie("/api/admin/exports/factures.csv");
  ...
  return new Response(reponse.body, {
    ...
    headers: {
      ...
      "Content-Disposition": reponse.headers.get("Content-Disposition") ?? "attachment; filename=factures.csv",
    },
  });
}
